...
{
    public partial class FRepFugasEvasiones : Form
    {
        ...
        {
            DTListarHistorialSeguimientoSocialPacientesReportes = TAListarHistorialSeguimientoSocialPacientesReportes.GetData(null, null, null, null, null, true, dateFechaInicio.Value, dateFechaFin.Value, null);
