...
{
    public partial class FReportePacientesSeguimientoSocial : FReporteGeneral
    {
        public FReportePacientesSeguimientoSocial()
        {
            InitializeComponent();
        }
        ...
        {
            this.fuenteReporteGeneral = new CRPacientesSeguimientoSocial();
